...
def addimage(link, x,
             y):  # function to draw image with its left top border at (x,y) pixel(origin is at top left of screen and y axis down and x axis right)
...
def button(msg, x, y, l, h, ac, ic, function,
           tc):  # this function creates a button and provides functions to be done on clicking it
...
def text_in_box(text, font, tc, x, y, l,
                h):  # this function will write the text in the box whose coordinates and length and breadth are given
...
def message_to_screen(msg, color, x, y,
                      s):  # this function will print the message on the game screeen with the start coordinates given to it as argument
